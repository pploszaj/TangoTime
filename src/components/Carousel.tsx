...
const Carousel = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      name: "Samba",
      description: "Born in the lively carnivals of Brazil, samba is an exuberant latin dance that embodies the rhythms and spirit of South American culture. Recognized by its rhythmic bounce, rolling hip actions, and festive flair, samba dancers move with a pulsating energy that's both joyful and infectious. The dance is set to a distinctive 2/4 beat, marrying swift footwork with graceful body movements, evoking the vibrant parades from which it takes inspiration.",
    },
  ];
